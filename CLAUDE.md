...
- **Tools** (`tools/`): Offline scripts to fetch protocol docs, parse DOT files, generate diffs
...
- `python tools/fetch_protocol_docs.py` — fetch protocol DOT files from BedrockProtocol repo
- `python tools/parse_dot_files.py` — parse DOT → JSON
