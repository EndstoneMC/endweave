"""Packet handler for CameraInstruction (300) -- v924 server to v898 client.
...
def rewrite_camera_instruction(wrapper: PacketWrapper) -> None:
    """CameraInstruction (300): strip easing from spline keyframes for v898 clients.
    ...
    if wrapper.passthrough(BOOL):
        wrapper.map(SPLINE_INSTRUCTION_V924, SPLINE_INSTRUCTION_V898)
