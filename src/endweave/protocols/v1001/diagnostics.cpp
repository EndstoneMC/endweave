...
void Transformer<bp::MemoryCategoryCounter_<1001>, bp::MemoryCategoryCounter_<2168>>::transform(
    Context<bp::MemoryCategoryCounter_<2168>> &ctx, bp::MemoryCategoryCounter_<1001> &&from)
{
    auto &to = ctx.out();
...
void Transformer<bp::ServerboundDiagnosticsPacket_<1001>, bp::ServerboundDiagnosticsPacket_<2168>>::transform(
    Context<bp::ServerboundDiagnosticsPacket_<2168>> &ctx, bp::ServerboundDiagnosticsPacket_<1001> &&from)
{
    auto &to = ctx.out();
