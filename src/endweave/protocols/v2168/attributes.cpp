...
void Transformer<bp::EnvironmentAttributeData_<2168>, bp::EnvironmentAttributeData_<2181>>::transform(
    Context<bp::EnvironmentAttributeData_<2181>> &ctx, bp::EnvironmentAttributeData_<2168> &&from)
{
    auto &to = ctx.out();
...
void Transformer<bp::AttributeLayerData_<2168>, bp::AttributeLayerData_<2181>>::transform(
    Context<bp::AttributeLayerData_<2181>> &ctx, bp::AttributeLayerData_<2168> &&from)
{
    auto &to = ctx.out();
    to.name = std::move(from.name);
...
void Transformer<bp::UpdateAttributeLayersData_<2168>, bp::UpdateAttributeLayersData_<2181>>::transform(
    Context<bp::UpdateAttributeLayersData_<2181>> &ctx, bp::UpdateAttributeLayersData_<2168> &&from)
{
    auto &to = ctx.out();
    to.attribute_layers = ew::transform(ctx, std::move(from.attribute_layers));
}

void Transformer<bp::UpdateEnvironmentAttributesData_<2168>, bp::UpdateEnvironmentAttributesData_<2181>>::transform(
    Context<bp::UpdateEnvironmentAttributesData_<2181>> &ctx, bp::UpdateEnvironmentAttributesData_<2168> &&from)
{
    auto &to = ctx.out();
...
void Transformer<bp::ClientboundAttributeLayerSyncPacket_<2168>, bp::ClientboundAttributeLayerSyncPacket_<2181>>::
    transform(Context<bp::ClientboundAttributeLayerSyncPacket_<2181>> &ctx,
    ...
    std::visit(
        [&to, &ctx](auto &alt) {
            ...
            if constexpr (std::is_same_v<Alt, bp::UpdateAttributeLayersData_<2168>>) {
                to.data = ew::transform_to<bp::UpdateAttributeLayersData_<2181>>(ctx, std::move(alt));
            }
            else if constexpr (std::is_same_v<Alt, bp::UpdateEnvironmentAttributesData_<2168>>) {
                to.data = ew::transform_to<bp::UpdateEnvironmentAttributesData_<2181>>(ctx, std::move(alt));
            }
            else {
