...
bp::CraftingDataEntry_<1001> shapedEntry(bp::CraftingDataEntryType entry_type, bp::ShapedRecipePayload_<2168> &&from)
{
    ...
    entry.shaped_recipe = ew::downgrade(from);
    return entry;
}
                                            ...
                                            bp::ShapelessRecipePayload_<2168> &&from)
{
    bp::CraftingDataEntry_<1001> entry;
    entry.entry_type = entry_type;
    entry.shapeless_recipe = ew::downgrade(from);
    return entry;
}
...
bp::SerializedNetworkItemInstanceDescriptor_<1001> Transformer<bp::SerializedNetworkItemInstanceDescriptor_<2168>>::
    downgrade(bp::SerializedNetworkItemInstanceDescriptor_<2168> &&from)
{
...
bp::SerializedRecipeIngredient_<1001> Transformer<bp::SerializedRecipeIngredient_<2168>>::downgrade(
...
bp::SerializedRecipeUnlockingRequirement_<1001> Transformer<bp::SerializedRecipeUnlockingRequirement_<2168>>::downgrade(
    bp::SerializedRecipeUnlockingRequirement_<2168> &&from)
{
    ...
    to.ingredients = ew::downgrade(from.ingredients).value_or(std::vector<bp::SerializedRecipeIngredient_<1001>>{});
    return to;
}

bp::ShapedRecipePayload_<1001> Transformer<bp::ShapedRecipePayload_<2168>>::downgrade(
    bp::ShapedRecipePayload_<2168> &&from)
{
    ...
    to.ingredients = ew::downgrade(from.ingredients);
    ...
    to.results = ew::downgrade(from.results);
    ...
    to.unlocking_requirement =
        ew::downgrade(from.unlocking_requirement).value_or(bp::SerializedRecipeUnlockingRequirement_<1001>{});
    to.net_id = from.net_id;
    return to;
}

bp::ShapelessRecipePayload_<1001> Transformer<bp::ShapelessRecipePayload_<2168>>::downgrade(
    bp::ShapelessRecipePayload_<2168> &&from)
{
...
bp::SmithingTransformRecipePayload_<1001> Transformer<bp::SmithingTransformRecipePayload_<2168>>::downgrade(
    bp::SmithingTransformRecipePayload_<2168> &&from)
{
    bp::SmithingTransformRecipePayload_<1001> to;
    to.recipe_id = std::move(from.recipe_id);
    to.template_ingredient = ew::downgrade(from.template_ingredient);
    to.base_ingredient = ew::downgrade(from.base_ingredient);
    to.addition_ingredient = ew::downgrade(from.addition_ingredient);
    to.result = ew::downgrade(from.result);
    to.tag = std::move(from.tag);
    to.net_id = from.net_id;
    return to;
}

bp::SmithingTrimRecipePayload_<1001> Transformer<bp::SmithingTrimRecipePayload_<2168>>::downgrade(
...
bp::CraftingDataPacket_<1001> Transformer<bp::CraftingDataPacket_<2168>>::downgrade(
    bp::CraftingDataPacket_<2168> &&from)
{
    ...
    for (auto &recipe : from.smithing_transform_recipes) {
        ...
        entry.smithing_transform_recipe = ew::downgrade(recipe);
    ...
    for (auto &recipe : from.smithing_trim_recipes) {
        ...
        entry.smithing_trim_recipe = ew::downgrade(recipe);
        to.crafting_entries.push_back(std::move(entry));
    }
...
bp::CreativeGroupInfoPayload_<1001> Transformer<bp::CreativeGroupInfoPayload_<2168>>::downgrade(
    bp::CreativeGroupInfoPayload_<2168> &&from)
{
    ...
    to.group_icon_item = ew::downgrade(from.group_icon_item);
    return to;
}

bp::CreativeItemEntryPayload_<1001> Transformer<bp::CreativeItemEntryPayload_<2168>>::downgrade(
    bp::CreativeItemEntryPayload_<2168> &&from)
{
    bp::CreativeItemEntryPayload_<1001> to;
    to.creative_net_id = from.creative_net_id;
    to.item_instance = ew::downgrade(from.item_instance);
    to.group_index = from.group_index;
    return to;
}

bp::CreativeContentPacket_<1001> Transformer<bp::CreativeContentPacket_<2168>>::downgrade(
    bp::CreativeContentPacket_<2168> &&from)
{
    bp::CreativeContentPacket_<1001> to;
    to.groups = ew::downgrade(from.groups);
    to.entries = ew::downgrade(from.entries);
    return to;
}
