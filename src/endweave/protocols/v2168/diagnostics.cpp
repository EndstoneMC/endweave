...
void Transformer<bp::MemoryCategoryCounter_<2168>, bp::MemoryCategoryCounter_<2181>>::transform(
    Context<bp::MemoryCategoryCounter_<2181>> &ctx, bp::MemoryCategoryCounter_<2168> &&from)
{
    auto &to = ctx.out();
...
void Transformer<bp::EntityDiagnosticTimingInfo_<2168>, bp::EntityDiagnosticTimingInfo_<2181>>::transform(
    Context<bp::EntityDiagnosticTimingInfo_<2181>> &ctx, bp::EntityDiagnosticTimingInfo_<2168> &&from)
{
    auto &to = ctx.out();
...
void Transformer<bp::ServerboundDiagnosticsPacket_<2168>, bp::ServerboundDiagnosticsPacket_<2181>>::transform(
    Context<bp::ServerboundDiagnosticsPacket_<2181>> &ctx, bp::ServerboundDiagnosticsPacket_<2168> &&from)
{
    auto &to = ctx.out();
    to.avg_fps = from.avg_fps;
    to.avg_server_sim_tick_time_ms = from.avg_server_sim_tick_time_ms;
