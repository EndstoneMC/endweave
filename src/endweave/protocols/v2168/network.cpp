...
void Transformer<bp::DisconnectPacket_<2168>, bp::DisconnectPacket_<2181>>::transform(
    Context<bp::DisconnectPacket_<2181>> &ctx, bp::DisconnectPacket_<2168> &&from)
{
...
void Transformer<bp::PacketViolationWarningPacket_<2168>, bp::PacketViolationWarningPacket_<2181>>::transform(
    Context<bp::PacketViolationWarningPacket_<2181>> &ctx, bp::PacketViolationWarningPacket_<2168> &&from)
{
