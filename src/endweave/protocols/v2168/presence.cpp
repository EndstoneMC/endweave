...
void Transformer<bp::PresenceConfiguration_<2168>, bp::PresenceConfiguration_<1001>>::transform(
    Context<bp::PresenceConfiguration_<1001>> &ctx, bp::PresenceConfiguration_<2168> &&from)
{
    auto &to = ctx.out();
...
void Transformer<bp::GatheringsConfigurationJoinInfo_<2168>, bp::GatheringsConfigurationJoinInfo_<1001>>::transform(
    Context<bp::GatheringsConfigurationJoinInfo_<1001>> &ctx, bp::GatheringsConfigurationJoinInfo_<2168> &&from)
{
    auto &to = ctx.out();
