...
namespace endweave {
void Transformer<bp::EnvironmentAttributeData_<2168>, bp::EnvironmentAttributeData_<2193>>::transform(
    Context<bp::EnvironmentAttributeData_<2193>> &ctx, bp::EnvironmentAttributeData_<2168> &&from)
{
    auto &to = ctx.out();
    ...
    // is the only thing 2193 could be told.
    to.noise_alignment = {};
}
