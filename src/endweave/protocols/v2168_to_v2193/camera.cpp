...
namespace endweave {
void Transformer<bp::CameraPreset_<2168>, bp::CameraPreset_<2193>>::transform(Context<bp::CameraPreset_<2193>> &ctx,
                                                                              bp::CameraPreset_<2168> &&from)
{
    ...
    // what 2193 writes for a preset that sets neither.
