...
void Transformer<bp::DimensionDefinitionGroup_<2168>::DimensionDefinition,
                 bp::DimensionDefinitionGroup_<2193>::DimensionDefinition>::
    transform(Context<bp::DimensionDefinitionGroup_<2193>::DimensionDefinition> &ctx,
              bp::DimensionDefinitionGroup_<2168>::DimensionDefinition &&from)
{
    auto &to = ctx.out();
    // ENDWEAVE: 2193 keeps the two leading members in place and stops meaning by them what 2168 did:
    ...
    // ENDWEAVE: 2168 names no biome for a dimension, and empty is what 2193 writes for one that
