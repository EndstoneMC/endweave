...
void Transformer<bp::ServerboundPackSettingChangePacket_<2168>, bp::ServerboundPackSettingChangePacket_<2193>>::
    transform(Context<bp::ServerboundPackSettingChangePacket_<2193>> &ctx,
              bp::ServerboundPackSettingChangePacket_<2168> &&from)
{
    ...
    // ENDWEAVE: 2193 added a list of strings as a fourth setting shape. 2168 can never send one, so
