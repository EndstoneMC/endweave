...
struct Transformer<bp::CameraPreset_<2181>, bp::CameraPreset_<2168>> {
    static bp::CameraPreset_<2168> transform(bp::CameraPreset_<2181> &&from);
};

template <>
struct Transformer<bp::CameraPresets_<2181>, bp::CameraPresets_<2168>> {
    static bp::CameraPresets_<2168> transform(bp::CameraPresets_<2181> &&from);
};

template <>
struct Transformer<bp::CameraPresetsPacket_<2181>, bp::CameraPresetsPacket_<2168>> {
    static bp::CameraPresetsPacket_<2168> transform(bp::CameraPresetsPacket_<2181> &&from);
};
