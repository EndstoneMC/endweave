...
void Transformer<bp::DisconnectPacket_<2181>, bp::DisconnectPacket_<2168>>::transform(
    Context<bp::DisconnectPacket_<2168>> &ctx, bp::DisconnectPacket_<2181> &&from)
{
...
void Transformer<bp::PacketViolationWarningPacket_<2181>, bp::PacketViolationWarningPacket_<2168>>::transform(
    Context<bp::PacketViolationWarningPacket_<2168>> &ctx, bp::PacketViolationWarningPacket_<2181> &&from)
{
