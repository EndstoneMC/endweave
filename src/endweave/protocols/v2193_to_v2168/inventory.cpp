...
void Transformer<bp::ItemUseInventoryTransaction_<2193>::ActionType,
...
void Transformer<bp::ContainerOpenPacket_<2193>, bp::ContainerOpenPacket_<2168>>::transform(
    Context<bp::ContainerOpenPacket_<2168>> &ctx, bp::ContainerOpenPacket_<2193> &&from)
{
...
void Transformer<bp::ContainerClosePacket_<2193>, bp::ContainerClosePacket_<2168>>::transform(
    Context<bp::ContainerClosePacket_<2168>> &ctx, bp::ContainerClosePacket_<2193> &&from)
{
