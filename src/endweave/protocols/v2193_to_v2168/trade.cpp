...
void Transformer<bp::UpdateTradePacket_<2193>, bp::UpdateTradePacket_<2168>>::transform(
    Context<bp::UpdateTradePacket_<2168>> &ctx, bp::UpdateTradePacket_<2193> &&from)
{
...
void Transformer<bp::UpdateEquipPacket_<2193>, bp::UpdateEquipPacket_<2168>>::transform(
    Context<bp::UpdateEquipPacket_<2168>> &ctx, bp::UpdateEquipPacket_<2193> &&from)
{
    const auto type = bp::enum_cast<bp::ContainerType_<2168>>(bp::enum_name(from.type));
    if (!type) {
        ctx.cancel();
